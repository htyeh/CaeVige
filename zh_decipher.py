...
from main import zh_decipher, zh_decipher_key
import sys
import os
import time
import argparse
...
parser.add_argument(
    "-f", "--file", help="Specify file to be decrypted.", required=True)
parser.add_argument(
...
deciphered_msg = zh_decipher_key(msg, key)
...
end_time = time.time()
print(args.file + " (" + str(len(msg)) + " char(s)) decrypted in " +
