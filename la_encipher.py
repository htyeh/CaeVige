...
from main import la_encipher, la_encipher_key
import sys
import os
import time
import argparse
...
parser.add_argument("-f", "--file", help="Specify file to be encrypted.", required=True)
...
enciphered_msg = la_encipher_key(msg,key)
...
end_time = time.time()
print(args.file + " (" + str(len(msg)) + " char(s)) encrypted in " + str(round(end_time-start_time, 2)) + " second(s).")
